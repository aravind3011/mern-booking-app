...
This is a Fully functional Hotel Booking app achiveved thorugh MERN Stack, Tailwind css, Typescript, React hook, cloudinary and stripe for payments and images
...
```bash
git clone https://github.com/aravind3011/mern-booking-app.git
cd mern-booking-app
```
